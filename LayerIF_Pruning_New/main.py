...
#     if "7b" in args.model or '13b' in args.model or "30b" in args.model or "65b" in args.model or "70b" in args.model: # for 30b or 65b or 70b, we use device_map to load onto multiple GPUs, thus the processing here.
